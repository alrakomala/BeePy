...
#### ¡Hola! En este taller vamos a aplicar técnicas de análisis de datos (limpieza, visualización, análisis descriptivo, machine learning) a los datos públicos de la NASA sobre exoplanetas.

## Introducción

El primer exoplaneta fue descubierto en 1990 y desde entonces se han identificado miles utilizando diversas técnicas como: tránsito, velocidad radial, imagen directa, microlenteado, entre otros. La misión que ha descubierto más exoplanetas ha sido **Kepler**, telescopio espacial que estuvo dedicado cerca de 10 años a la búsqueda de planetas extrasolares, especialmente aquellos de tamaño similar a la Tierra y que se encuentran en la zona de habitabilidad de su estrella.
...
Analizando la curva de luz es posible determinar el tamaño y masa del planeta, para después calcular su composición (rocoso o gaseoso). 
